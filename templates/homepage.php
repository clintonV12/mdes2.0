                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h4 class="text-c-purple">Profile</h4>
                                            <h6 class="text-muted m-b-0">Profile info</h6>
                                        </div>
                                ...
                                <div class="card-footer bg-c-purple">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <a href="profile.php" class="text-white m-b-0">Open</a>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-block">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h4 class="text-c-green">History</h4>
                                            <h6 class="text-muted m-b-0">Medical history</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                ...
                                <div class="card-footer bg-c-green">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <a href="history.php" class="text-white m-b-0">Open</a>
                                        </div>
                                        <div class="col-3 text-right">
                                            <a href="history.php">
                                                <i class="fa fa-external-link text-white f-16"></i>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-block">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h4 class="text-c-blue">Diagnosis</h4>
                                            <h6 class="text-muted m-b-0">Patient diagnosis</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                            <i class="fa fa-user-md f-28"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer bg-c-blue">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <a href="diagnosis.php" class="text-white m-b-0">Open</a>
                                        </div>
                                        <div class="col-3 text-right">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-block">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h4 class="text-c-red">Results</h4>
                                            <h6 class="text-muted m-b-0">Diagnosis results</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                            <i class="fa fa-clipboard f-28"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer bg-c-red">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <a href="results.php" class="text-white m-b-0">Open</a>
                                        </div>
                                        <div class="col-3 text-right">
                                            <a href="results.php">
                                                <i class="fa fa-external-link text-white f-16"></i>
